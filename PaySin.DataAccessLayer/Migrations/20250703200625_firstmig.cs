...
namespace PaySin.DataAccessLayer.Migrations
{
    public partial class firstmig : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CustomerAccountProsesses",
                columns: table => new
                {
                    CustomerAccountProsessID = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerAccountProsesses", x => x.CustomerAccountProsessID);
                });
